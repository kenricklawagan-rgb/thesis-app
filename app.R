...
ui <- page_sidebar(
  ...
  sidebar = sidebar(
    ...
    # Section B: Summary Metric Cards (Stacked for Clarity)
    value_box(
    ...
    br(),
    # Section C: Dynamic Assessment Output
    uiOutput("assessment_panel"),
    
    br(),
    # Section D: Technical Descriptions
    accordion(
      open = FALSE,
      accordion_panel(
  ...
  # MAIN RIGHT AREA: PROMINENT MAP ONLY
  card(
    full_screen = TRUE,
...
server <- function(input, output, session) {
  ...
  # Click Map to Auto-Set Epicenter Location
  ...
  # Prediction Triggered by Compute Button (or default load)
  ...
  # Dynamic Assessment Card in Left Sidebar
